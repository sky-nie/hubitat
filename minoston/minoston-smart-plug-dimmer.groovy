/**
 *      Minoston Smart Plug Dimmer v1.0.0(HUBITAT)
 *
 *  	Models: MP21ZD
 *
 *  Author:
...
metadata {
    definition (
            name: "Minoston Smart Plug Dimmer(MP21ZD)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-dimmer",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/minoston/minoston-smart-plug-dimmer.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
