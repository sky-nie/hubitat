/**
 *      Minoston Outdoor Dimmer v1.0.0(HUBITAT)
 *
 *  	Models: MP22ZD
 *
 *  Author:
...
metadata {
    definition (
            name: "Minoston Outdoor Dimmer(MP22ZD)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-dimmer",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/minoston/minoston-outdoor-dimmer.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
