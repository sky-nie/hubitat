/**
 *      Minoston Mini Smart Plug v1.0.0(HUBITAT)
 *
 *  	Models: MP21Z
 *
 *  Author:
...
metadata {
    definition (
            name: "Minoston Mini Smart Plug(MP21Z)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-switch",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/minoston/minoston-mini-smart-plug.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
