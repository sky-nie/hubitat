/**
 *  Minoston Power Meter Plug v1.0.0(HUBITAT)
 *
 *  Models: ZW38M
 *
 *  Author:
...
metadata {
	definition (
            name: "Minoston Power Meter Plug(ZW38M)",
            namespace: "sky-nie",
            author: "winnie",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/minoston/minoston-power-meter-plug.groovy"
	) {
		capability "Actuator"
		capability "Sensor"
		capability "Switch"
		...
		fingerprint mfr: "0312", prod: "FF00", deviceId: "FF11", deviceJoinName: "Minoston Outlet Meter", inClusters:"0x5E,0x55,0x9F,0x6C"//Minoston Power Meter Plug, ZW38M
		fingerprint mfr: "0312", prod: "FF00", deviceId: "FF11", deviceJoinName: "Minoston Outlet Meter", inClusters:"0x86,0x25,0x70,0x85,0x8E,0x59,0x32,0x71,0x72,0x5A,0x87,0x73,0x7A"
	}
