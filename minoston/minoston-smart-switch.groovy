/**
 *  Minoston Smart Switch v1.0.1(HUBITAT)
 *
 *  	Models: MS10ZS
 *
 *  Author:
...
metadata {
    definition (
            name: "Minoston Smart Switch(MS10ZS)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-switch",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/minoston/minoston-smart-switch.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
        ...
        fingerprint mfr: "0312", prod: "EE00", deviceId: "EE01", deviceJoinName: "Minoston Switch", ocfDeviceType: "oic.d.switch", inClusters:"0x5E,0x55,0x9F,0x6C"    //MS10ZS Minoston Smart Switch
        fingerprint mfr: "0312", prod: "EE00", deviceId: "EE01", deviceJoinName: "Minoston Switch", ocfDeviceType: "oic.d.switch", inClusters:"0x86,0x25,0x70,0x5B,0x85,0x8E,0x59,0x72,0x5A,0x73,0x7A"
    }
