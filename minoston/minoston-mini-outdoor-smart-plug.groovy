/**
 *      Minoston Mini Outdoor Smart Plug v1.0.1(HUBITAT)
 *
 *  	Models: MP22Z
 *
 *  Author:
...
metadata {
    definition (
            name: "Minoston Mini Outdoor Smart Plug(MP22Z)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-switch",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/minoston/minoston-mini-outdoor-smart-plug.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
