/**
 *      Minoston Smart Dimmer Switch v1.0.1(HUBITAT)
 *
 *  	Models: MS11ZS
 *
 *  Author:
...
metadata {
    definition (
            name: "Minoston Smart Dimmer Switch(MS11ZS)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-dimmer",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/minoston/minoston-smart-dimmer-switch.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
