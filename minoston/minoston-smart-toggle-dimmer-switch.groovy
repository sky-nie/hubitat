...
metadata {
    definition (
            name: "Minoston Smart Toggle Dimmer Switch(MS13ZS)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-dimmer",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/minoston/minoston-smart-toggle-dimmer-switch.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
