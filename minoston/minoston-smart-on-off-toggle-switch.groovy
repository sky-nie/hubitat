...
metadata {
    definition (
            name: "Minoston Smart on/off Toggle Switch(MS12ZS)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-switch",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/minoston/minoston-smart-on-off-toggle-switch.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
