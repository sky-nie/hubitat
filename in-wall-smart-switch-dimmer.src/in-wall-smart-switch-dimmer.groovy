/**
 *      In-Wall Smart Switch Dimmer v1.0.0(HUBITAT)
 *
...
metadata {
    definition (
            ...
            mnmn: "SmartThings",
            vid:"generic-dimmer",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/in-wall-smart-switch-dimmer.src/in-wall-smart-switch-dimmer.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
        ...
        fingerprint mfr: "0312", prod: "0004", deviceId: "EE02", deviceJoinName: "Minoston Dimmer Switch", ocfDeviceType: "oic.d.switch", inClusters:"0x5E,0x26,0x70,0x5B,0x85,0x8E,0x59,0x55,0x86,0x72,0x5A,0x87,0x73,0x9F,0x6C,0x7A"    //MS11ZS Minoston Smart Dimmer Switch
        ...
        fingerprint mfr: "0312", prod: "BB00", deviceId: "BB02", deviceJoinName: "Evalogik Dimmer Switch", ocfDeviceType: "oic.d.switch", inClusters:"0x5E,0x26,0x70,0x5B,0x85,0x8E,0x59,0x55,0x86,0x72,0x5A,0x87,0x73,0x9F,0x6C,0x7A"    //ZW31S Evalogik Smart Dimmer Switch
        fingerprint mfr: "0312", prod: "BB00", deviceId: "BB04", deviceJoinName: "Evalogik Dimmer Switch", ocfDeviceType: "oic.d.switch", inClusters:"0x5E,0x26,0x70,0x5B,0x85,0x8E,0x59,0x55,0x86,0x72,0x5A,0x87,0x73,0x9F,0x6C,0x7A"    //ZW31TS Evalogik Smart Toggle Dimmer Switch
    }
