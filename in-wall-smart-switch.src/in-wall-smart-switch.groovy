/**
 *  In-Wall Smart Switch v1.0.0(HUBITAT)
 *
...
metadata {
    definition (
            ...
            mnmn: "SmartThings",
            vid:"generic-switch",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/in-wall-smart-switch.src/in-wall-smart-switch.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
