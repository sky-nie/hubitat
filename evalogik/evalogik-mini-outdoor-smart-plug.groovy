...
metadata {
    definition (
            name: "Evalogik Mini Outdoor Smart Plug(ZW96S)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-switch",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/evalogik-mini-outdoor-smart-plug.src/evalogik-mini-outdoor-smart-plug.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
        ...
        fingerprint mfr: "0312", prod: "C000", deviceId: "C005", deviceJoinName: "Minoston Outlet", ocfDeviceType: "oic.d.smartplug", inClusters:"0x5E,0x55,0x9F,0x6C" //ZW96S Evalogik  Mini Outdoor Smart Plug
    }
