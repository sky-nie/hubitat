/**
 *      Evalogik Smart Toggle Dimmer Switch v1.0.1(HUBITAT)
 *
 *  	Models: ZW31TS
 *
 *  Author:
 ...
 *
 * Reference：
 *    https://github.com/krlaframboise/SmartThings/blob/master/devicetypes/krlaframboise/eva-logik/eva-logik-in-wall-smart-dimmer.groovy
 *
...
metadata {
    definition (
            name: "Evalogik Smart Toggle Dimmer Switch(ZW31TS)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-dimmer",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/evalogik/evalogik-smart-toggle-dimmer-switch.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
