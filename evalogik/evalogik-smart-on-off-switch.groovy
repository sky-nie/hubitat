/**
 *  Evalogik Smart on/off Switch v1.0.0(HUBITAT)
 *
 *  	Models: ZW30S
 *
 *  Author:
...
metadata {
    definition (
            name: "Evalogik Smart on/off Switch(ZW30S)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-switch",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/evalogik-smart-on-off-switch.src/evalogik-smart-on-off-switch.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
