/**
 *  Evalogik Smart on/off Switch v1.0.1(HUBITAT)
 *
 *  	Models: ZW30S
 *
 *  Author:
...
metadata {
    definition (
            ...
            mnmn: "SmartThings",
            vid:"generic-switch",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/evalogik/evalogik-smart-on-off-switch.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
