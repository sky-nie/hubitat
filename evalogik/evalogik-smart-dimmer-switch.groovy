/**
 *      Evalogik Smart Dimmer Switch v1.0.1(HUBITAT)
 *
 *  	Models: ZW31S
 *
 *  Author:
...
metadata {
    definition (
            name: "Evalogik Smart Dimmer Switch(ZW31S)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-dimmer",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/evalogik/evalogik-smart-dimmer-switch.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
        ...
        fingerprint mfr: "0312", prod: "EE00", deviceId: "EE02", deviceJoinName: "Evalogik Dimmer Switch", ocfDeviceType: "oic.d.switch", inClusters:"0x5E,0x26,0x70,0x5B,0x85,0x8E,0x59,0x55,0x86,0x72,0x5A,0x87,0x73,0x9F,0x6C,0x7A"
