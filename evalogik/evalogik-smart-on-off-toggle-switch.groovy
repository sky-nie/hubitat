...
metadata {
    definition (
            name: "Evalogik Smart on/off Toggle Switch(ZW30TS)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-switch",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/evalogik-smart-on-off-toggle-switch.src/evalogik-smart-on-off-toggle-switch.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
