/**
 *      NewOne Mini Smart Plug v1.0.0(HUBITAT)
 *
 *  	Models: N4001
 *
 *  Author:
...
metadata {
    definition (
            name: "NewOne Mini Smart Plug(N4001)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-switch",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/newone/newone-mini-smart-plug.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
