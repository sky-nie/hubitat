/**
 *  NewOne Power Meter Plug v1.0.0(HUBITAT)
 *
 *  Models: N4003
 *
 *  Author:
...
metadata {
	definition (
            name: "NewOne Power Meter Plug(N4003)",
            namespace: "sky-nie",
            author: "winnie",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/newone/newone-power-meter-plug.groovy"
	) {
		capability "Actuator"
		capability "Sensor"
		capability "Switch"
		...
		fingerprint mfr: "0312", prod: "AC01", deviceId: "4003", deviceJoinName: "New One Outlet Meter",  inClusters:"0x5E,0x55,0x9F,0x6C"//NewOne Power Meter Plug, N4003
		fingerprint mfr: "0312", prod: "AC01", deviceId: "4003", deviceJoinName: "New One Outlet Meter",  inClusters:"0x86,0x25,0x70,0x85,0x8E,0x59,0x32,0x71,0x72,0x5A,0x87,0x73,0x7A"
	}
