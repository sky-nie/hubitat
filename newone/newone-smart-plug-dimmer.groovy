/**
 *      NewOne Smart Plug Dimmer v1.0.0(HUBITAT)
 *
 *  	Models: N4002
 *
 *  Author:
...
metadata {
    definition (
            name: "NewOne Smart Plug Dimmer(N4002)",
            namespace: "sky-nie",
            author: "winnie",
            mnmn: "SmartThings",
            vid:"generic-dimmer",
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/newone/newone-smart-plug-dimmer.groovy"
    ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
