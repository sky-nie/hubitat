/**
 *  Minoston Wallmote v1.0.4(HUBITAT)
 *
...
metadata {
    definition (
            ...
            author: "winnie",
            mcdSync: true,
            importUrl: "https://raw.githubusercontent.com/sky-nie/hubitat/main/minoston-wallmote.src/minoston-wallmote.groovy"
    ) {
        capability "Actuator"
        capability "Battery"
...
void zwaveEvent(hubitat.zwave.commands.supervisionv1.SupervisionGet cmd) {
	...
	sendCommands([secureCmd(zwave.supervisionV1.supervisionReport(sessionID: cmd.sessionID, reserved: 0, moreStatusUpdates: false, status: 0xFF, duration: 0))], null)
}
/************************************** Addon codes Over ******************************************************************/